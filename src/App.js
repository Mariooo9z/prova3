...
const App = () => {
  ...
  const changeNumberOfQuestions = (subject, operation) => {
    setSelectedQuestions((prevState) => {
      const updatedValue = operation === '+' ? prevState[subject] + 1 : prevState[subject] - 1;
      return {
        ...prevState,
      ...
      {!quizStarted ? (
        <div>
          ...
          <form>
            <div className="form-group">
              ...
              <div className="input-group">
                <button
                  ...
                  onClick={() => changeNumberOfQuestions('acidiNucleici', '-')}
                >
                  -
                </button>
                <input
            ...
            <div className="form-group">
              ...
              <div className="input-group">
                <button
                  type="button"
                  className="button-small"
                  onClick={() => changeNumberOfQuestions('flussoDiInformazioni', '-')}
                >
                  -
                </button>
                <input
            ...
            <div className="form-group">
              ...
              <div className="input-group">
                <button
                  type="button"
                  className="button-small"
                  onClick={() => changeNumberOfQuestions('macromolecole', '-')}
                >
                  -
                </button>
                <input
            ...
            <div className="form-group">
              ...
              <div className="input-group">
                <button
                  type="button"
                  className="button-small"
                  onClick={() => changeNumberOfQuestions('trasportoMembrane', '-')}
                >
                  -
                </button>
                <input
            ...
            <div className="form-group">
              ...
              <div className="input-group">
                <button
                  type="button"
                  className="button-small"
                  onClick={() => changeNumberOfQuestions('organismiViventi', '-')}
                >
                  -
                </button>
                <input
            ...
            <button type="button" onClick={startQuiz}>Avvia il Quiz</button>
          </form>
        </div>
      ) : (
